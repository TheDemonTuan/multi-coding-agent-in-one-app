          ...
          {activeTab === 'terminal' && (
            <div style={styles.tabContent}>
              ...
              <div style={styles.section}>
                ...
                <input type="number" min={100} max={10000} step={100} value={settings.scrollback} onChange={(e) => setSettings({...settings, scrollback: parseInt(e.target.value) || 300})} style={styles.input} />
                <p style={{fontSize: '11px', color: '#6c7086', marginTop: '4px'}}>Recommended: 300-500 lines for optimal performance (Option C: Balanced)</p>
              </div>
