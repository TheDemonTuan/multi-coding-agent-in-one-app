...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  spawnTerminalWithAgent: (id, cwd, agentConfig, workspaceId) =>
    ipcRenderer.invoke("spawn-terminal-with-agent", { id, cwd, agentConfig, workspaceId }),
  // terminalWrite uses 'send' (fire-and-forget) instead of 'invoke' (round-trip)
  // to eliminate IPC overhead per keystroke — no response needed.
  ...
  restartClaudeTerminals: (workspaceId, terminals) =>
    ipcRenderer.invoke("restart-claude-terminals", workspaceId, terminals),
