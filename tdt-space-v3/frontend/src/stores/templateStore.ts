...
const BUILTIN_TEMPLATES: Template[] = [
  { id: 'single',   name: 'Single',   description: '1 terminal',          layout: 'single',   columns: 1, rows: 1, icon: '①', isBuiltIn: true, createdAt: 0 },
  { id: 'dual',     name: 'Dual',     description: '2 terminals side-by-side', layout: 'dual', columns: 2, rows: 1, icon: '②', isBuiltIn: true, createdAt: 0 },
  { id: 'quad',     name: 'Quad',     description: '4 terminals (2x2)',    layout: 'quad',     columns: 2, rows: 2, icon: '④', isBuiltIn: true, createdAt: 0 },
  { id: 'six',      name: 'Six',      description: '6 terminals (3x2)',    layout: 'six',      columns: 3, rows: 2, icon: '⑥', isBuiltIn: true, createdAt: 0 },
  { id: 'eight',    name: 'Eight',    description: '8 terminals (4x2)',    layout: 'eight',    columns: 4, rows: 2, icon: '⑧', isBuiltIn: true, createdAt: 0 },
  { id: 'ten',      name: 'Ten',      description: '10 terminals (5x2)',   layout: 'ten',      columns: 5, rows: 2, icon: '⑩', isBuiltIn: true, createdAt: 0 },
  { id: 'twelve',   name: 'Twelve',   description: '12 terminals (4x3)',   layout: 'twelve',   columns: 4, rows: 3, icon: '⑫', isBuiltIn: true, createdAt: 0 },
  { id: 'fourteen', name: 'Fourteen', description: '14 terminals (7x2)',   layout: 'fourteen', columns: 7, rows: 2, icon: '⑭', isBuiltIn: true, createdAt: 0 },
  { id: 'sixteen',  name: 'Sixteen',  description: '16 terminals (4x4)',   layout: 'sixteen',  columns: 4, rows: 4, icon: '⑯', isBuiltIn: true, createdAt: 0 },
];
...
export const useTemplateStore = create<TemplateState>((set, get) => ({
  ...
  loadTemplates: async () => {
    set({ isLoading: true });
    try {
      const storedTemplates = await backendAPI.getTemplates();
  ...
  saveCustomTemplate: async (template: Template) => {
    ...
    try {
      await backendAPI.saveTemplate(template);
